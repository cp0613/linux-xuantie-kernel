...
/**
 * struct rdt_mon_domain - compat alias for code using pre-rename struct name.
 * Contains fields as they existed before the rdt_l3_mon_domain rename, with
 * struct cacheinfo *ci pointer (vs ci_id) and separate mbm_total/mbm_local.
 */
