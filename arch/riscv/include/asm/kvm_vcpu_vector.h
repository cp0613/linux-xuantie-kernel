...
static inline void kvm_riscv_vcpu_m_reset(struct kvm_vcpu *vcpu)
{
}

static inline void kvm_riscv_vcpu_guest_m_save(struct kvm_cpu_context *cntx,
					       unsigned long *isa)
{
}

static inline void kvm_riscv_vcpu_guest_m_restore(struct kvm_cpu_context *cntx,
						  unsigned long *isa)
{
}

static inline void kvm_riscv_vcpu_host_m_save(struct kvm_cpu_context *cntx)
{
}

static inline void kvm_riscv_vcpu_host_m_restore(struct kvm_cpu_context *cntx)
{
}

static inline int kvm_riscv_vcpu_alloc_m_context(struct kvm_vcpu *vcpu,
						      struct kvm_cpu_context *cntx)
{
	return 0;
}

static inline void kvm_riscv_vcpu_free_m_context(struct kvm_vcpu *vcpu)
{
}
#endif
