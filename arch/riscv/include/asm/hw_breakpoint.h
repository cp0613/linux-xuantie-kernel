...
#define RV_DBTR_BIT_SHIFT(_prefix, _name, _width)	\
	((((1ULL << _width) - 1) << RV_DBTR_BIT(_prefix, _name)))
...
enum {
#if __riscv_xlen == 64
	RV_DBTR_BIT_MASK(TDATA1, DATA) = RV_DBTR_BIT_SHIFT(TDATA1, DATA,  59),
#elif __riscv_xlen == 32
	RV_DBTR_BIT_MASK(TDATA1, DATA) = RV_DBTR_BIT_SHIFT(TDATA1, DATA,  27),
#else
	#error "Unknown __riscv_xlen"
#endif
	RV_DBTR_BIT_MASK(TDATA1, DMODE) = RV_DBTR_BIT_SHIFT(TDATA1, DMODE, 1),
	RV_DBTR_BIT_MASK(TDATA1, TYPE)  = RV_DBTR_BIT_SHIFT(TDATA1, TYPE,  4),
};
...
enum {
	RV_DBTR_BIT_MASK(MC, LOAD)    = RV_DBTR_BIT_SHIFT(MC, LOAD,    1),
	RV_DBTR_BIT_MASK(MC, STORE)   = RV_DBTR_BIT_SHIFT(MC, STORE,   1),
	RV_DBTR_BIT_MASK(MC, EXEC)    = RV_DBTR_BIT_SHIFT(MC, EXEC,    1),
	RV_DBTR_BIT_MASK(MC, U)       = RV_DBTR_BIT_SHIFT(MC, U,       1),
	RV_DBTR_BIT_MASK(MC, S)       = RV_DBTR_BIT_SHIFT(MC, S,       1),
	RV_DBTR_BIT_MASK(MC, RES2)    = RV_DBTR_BIT_SHIFT(MC, RES2,    1),
	RV_DBTR_BIT_MASK(MC, M)       = RV_DBTR_BIT_SHIFT(MC, M,       1),
	RV_DBTR_BIT_MASK(MC, MATCH)   = RV_DBTR_BIT_SHIFT(MC, MATCH,   4),
	RV_DBTR_BIT_MASK(MC, CHAIN)   = RV_DBTR_BIT_SHIFT(MC, CHAIN,   1),
	RV_DBTR_BIT_MASK(MC, ACTION)  = RV_DBTR_BIT_SHIFT(MC, ACTION,  4),
	RV_DBTR_BIT_MASK(MC, SIZELO)  = RV_DBTR_BIT_SHIFT(MC, SIZELO,  2),
	RV_DBTR_BIT_MASK(MC, TIMING)  = RV_DBTR_BIT_SHIFT(MC, TIMING,  1),
	RV_DBTR_BIT_MASK(MC, SELECT)  = RV_DBTR_BIT_SHIFT(MC, SELECT,  1),
	RV_DBTR_BIT_MASK(MC, HIT)     = RV_DBTR_BIT_SHIFT(MC, HIT,     1),
#if __riscv_xlen >= 64
	RV_DBTR_BIT_MASK(MC, SIZEHI)  = RV_DBTR_BIT_SHIFT(MC, SIZEHI,  2),
#endif
	RV_DBTR_BIT_MASK(MC, MASKMAX) = RV_DBTR_BIT_SHIFT(MC, MASKMAX, 6),
	RV_DBTR_BIT_MASK(MC, DMODE)   = RV_DBTR_BIT_SHIFT(MC, DMODE,   1),
	RV_DBTR_BIT_MASK(MC, TYPE)    = RV_DBTR_BIT_SHIFT(MC, TYPE,    4),
};
...
enum {
	RV_DBTR_BIT_MASK(MC6, LOAD)   = RV_DBTR_BIT_SHIFT(MC6, LOAD,   1),
	RV_DBTR_BIT_MASK(MC6, STORE)  = RV_DBTR_BIT_SHIFT(MC6, STORE,  1),
	RV_DBTR_BIT_MASK(MC6, EXEC)   = RV_DBTR_BIT_SHIFT(MC6, EXEC,   1),
	RV_DBTR_BIT_MASK(MC6, U)      = RV_DBTR_BIT_SHIFT(MC6, U,      1),
	RV_DBTR_BIT_MASK(MC6, S)      = RV_DBTR_BIT_SHIFT(MC6, S,      1),
	RV_DBTR_BIT_MASK(MC6, RES2)   = RV_DBTR_BIT_SHIFT(MC6, RES2,   1),
	RV_DBTR_BIT_MASK(MC6, M)      = RV_DBTR_BIT_SHIFT(MC6, M,      1),
	RV_DBTR_BIT_MASK(MC6, MATCH)  = RV_DBTR_BIT_SHIFT(MC6, MATCH,  4),
	RV_DBTR_BIT_MASK(MC6, CHAIN)  = RV_DBTR_BIT_SHIFT(MC6, CHAIN,  1),
	RV_DBTR_BIT_MASK(MC6, ACTION) = RV_DBTR_BIT_SHIFT(MC6, ACTION, 4),
	RV_DBTR_BIT_MASK(MC6, SIZE)   = RV_DBTR_BIT_SHIFT(MC6, SIZE,   4),
	RV_DBTR_BIT_MASK(MC6, TIMING) = RV_DBTR_BIT_SHIFT(MC6, TIMING, 1),
	RV_DBTR_BIT_MASK(MC6, SELECT) = RV_DBTR_BIT_SHIFT(MC6, SELECT, 1),
	RV_DBTR_BIT_MASK(MC6, HIT)    = RV_DBTR_BIT_SHIFT(MC6, HIT,    1),
	RV_DBTR_BIT_MASK(MC6, VU)     = RV_DBTR_BIT_SHIFT(MC6, VU,     1),
	RV_DBTR_BIT_MASK(MC6, VS)     = RV_DBTR_BIT_SHIFT(MC6, VS,     1),
#if __riscv_xlen == 64
	RV_DBTR_BIT_MASK(MC6, DMODE)  = RV_DBTR_BIT_SHIFT(MC6, DMODE,  1),
	RV_DBTR_BIT_MASK(MC6, TYPE)   = RV_DBTR_BIT_SHIFT(MC6, TYPE,   4),
#elif __riscv_xlen == 32
	RV_DBTR_BIT_MASK(MC6, DMODE)  = RV_DBTR_BIT_SHIFT(MC6, DMODE,  1),
	RV_DBTR_BIT_MASK(MC6, TYPE)   = RV_DBTR_BIT_SHIFT(MC6, TYPE,   4),
#else
