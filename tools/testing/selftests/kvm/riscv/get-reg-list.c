...
bool filter_reg(__u64 reg)
{
	...
	case KVM_REG_RISCV_SBI_EXT | KVM_REG_RISCV_SBI_SINGLE | KVM_RISCV_SBI_EXT_PVLOCK:
		return true;
...
static const char *sbi_ext_single_id_to_str(__u64 reg_off)
{
	...
	static const char * const kvm_sbi_ext_reg_name[] = {
		...
		KVM_SBI_EXT_ARR(KVM_RISCV_SBI_EXT_PVLOCK),
	};
...
static __u64 sbi_base_regs[] = {
	...
	KVM_REG_RISCV | KVM_REG_SIZE_ULONG | KVM_REG_RISCV_SBI_EXT | KVM_REG_RISCV_SBI_SINGLE | KVM_RISCV_SBI_EXT_PVLOCK,
};
